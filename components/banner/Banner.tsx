...
const Banner = () => {
  return (
    <div className="bg-primeColor py-10 w-full rounded-bl-3xl rounded-br-3xl relative px-4">
      <div className="text-white max-w-screen-2xl mx-auto grid md:grid-cols-2 gap-20 font-titleFont place-items-center">
        <div className="flex flex-col gap-6 xl:gap-10">
          <motion.h1
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 2 }}
            className="text-3xl md:text-2xl mdl:text-3xl lgl:text-4xl xl:text-6xl font-bold"
          >
            Creative Studio
          </motion.h1>
          <motion.p
            ...
            className="text-sm mdl:text-base tracking-wide"
          >
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis
            obcaecati, ut illum explicabo consequatur nostrum officiis
            assumenda. Suscipit accusamus aut, ullam, similique omnis laudantium
            impedit facilis quidem assumenda provident soluta, at tenetur
            mollitia blanditiis praesentium accusantium. Praesentium natus porro
            doloremque odio eos in, quas quos! Eum fugiat molestias quo ut!
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}
            className="w-full p-6 xl:p-10 bg-white rounded-3xl flex flex-col lg:flex-row text-black justify-between gap-5"
          >
            <input
